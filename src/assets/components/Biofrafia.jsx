            ...
            <div className='about-me my-auto pt-5'>
              <div className='img'>
                <div className='img-in'>
                  <img src='https://unavatar.io/Pachix-Dev' />
                </div>
                <div className='social-icons justify-content-center'>
                  <a href='https://www.facebook.com/pachi.claros/' rel='noreferrer' target='_blank'>
                  ...
                  <a href='https://www.linkedin.com/in/fabian-yapura-claros-132537227/' rel='noreferrer' target='_blank'>
                  ...
                  <a href='https://www.instagram.com/fabian.y.c/' rel='noreferrer' target='_blank'>
                  ...
                  <a href='https://github.com/Pachix-Dev' rel='noreferrer' target='_blank'>
                  ...
                  <a href='https://wa.me/+5214775690282?text=¡Hola!' rel='noreferrer' target='_blank'>
          ...
          <Col md={6} className='my-auto pt-5'>
            ...
            <Row>
              <Col sm={6} className='my-auto'>
                <ul>
                  <li><label>Nombre: </label><span> Fabian Yapura Claros</span></li>
                  <li><label>Grado: </label><span> Lic. Ingeniero en Sitemas</span></li>
              ...
              <Col sm={6} className='my-auto'>
                <ul>
                  <li><label>Ubicación: </label><span> León Guanajuato, México</span></li>
                  <li><label>Whatsapp: </label><span> (+52) 4775690282</span></li>
                  <li><label>Correo: </label><span> hola@yapura.com.mx</span></li>
                </ul>
              </Col>
            </Row>
          </Col>
